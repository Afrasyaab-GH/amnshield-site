...
PROJECT_NAME = _get_env("PROJECT_NAME", "AmnShield")
PROJECT_TAGLINE = _get_env(
    "PROJECT_TAGLINE",
    "Faith-Aligned Digital Protection for Healthier Digital Habits.",
)
PROJECT_URL = _get_env("PROJECT_URL", "https://amnshield.com")
...
with gr.Blocks(
    ...
    gr.ChatInterface(
        ...
        fill_height=True,
        examples=["What is AmnShield?", "Is AmnShield free?", "How do I download the app?"],
    )
